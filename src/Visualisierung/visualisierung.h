...
Snake_DBG_t Snake_VS_Update(Snake_Vektor_t snake[], //Pointer auf Vektoren-Array mit den Schlangenelementen, 1. Element (Index 0) immer Kopf 
                            unsigned short Anzahl,  //Länge der Schlange, bzw. Anzahl der Schlangenelemente
                            Snake_Vektor_t goody,   //Koordinaten des Goodys
...
Snake_DBG_t Snake_VS_draw_Vektor(Snake_Vektor_t vec, //Übergabe der Koordianten in Vektor-Form
                                 Snake_VS_chars zeichen); //Zeichen aus obigem Enum
